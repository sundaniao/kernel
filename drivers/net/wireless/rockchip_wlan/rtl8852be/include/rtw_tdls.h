...
static u8 TDLS_EXT_CAPIE_CHSW_SUP[] = {0x00, 0x00, 0x00, 0x50, 0x20, 0x00, 0x00, 0x00};	/* bit(28), bit(30), bit(37) */
#endif

static u8 TDLS_EXT_CAPIE[] = {0x00, 0x00, 0x00, 0x10, 0x20, 0x00, 0x00, 0x00};	/* bit(28), bit(37) */
