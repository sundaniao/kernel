...
struct cmd_scan_ctrl {
	...
	u8 fltr_mode; /* rtw_rx_fltr_opt_mode :: backup filter mode before off channel */
...
struct rtw_phl_scan_param {
	...
	u8 rxfltr_mode; /* enum rtw_rx_fltr_opt_mode */
...
enum rtw_phl_status phl_scan_rsc_init(void *phl_info);
void phl_scan_rsc_deinit(void *phl_info);
