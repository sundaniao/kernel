...
#include "halrf_hwimg_raw_data_8851b.h"
#include "halrf_hwimg_nctl_raw_data_8851b.h"

#ifdef RF_8851B_SUPPORT
u32 _halrf_power_limit_table_size_8851b(struct rf_info *rf, u8 ru, u8 band)
{
	...
	if (rfe_type == 2) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt_type2);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru_type2);
		}
	} else if (rfe_type == 3) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt_type3);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru_type3);
		}
	} else if (rfe_type == 4) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt_type4);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru_type4);
		}
	} else if (rfe_type == 5) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt_type5);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru_type5);
		}
	} else if (rfe_type == 6) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt_type6);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru_type6);
		}
	} else {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return sizeof(array_mp_8851b_txpwr_lmt);
		} else {
			return sizeof(array_mp_8851b_txpwr_lmt_ru);
		}
	}
}

void *_halrf_power_limit_table_addr_8851b(struct rf_info *rf, u8 ru, u8 band)
{
	u8 rfe_type = rf->phl_com->dev_cap.rfe_type;
	...
	if (rfe_type == 2) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt_type2;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru_type2;
		}
	} else if (rfe_type == 3) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt_type3;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru_type3;
		}
	} else if (rfe_type == 4) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt_type4;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru_type4;
		}
	} else if (rfe_type == 5) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt_type5;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru_type5;
		}
	} else if (rfe_type == 6) {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt_type6;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru_type6;
		}
	} else {
		if (ru == PW_LMT_TBL_NONE_RU) {
			return (void *) array_mp_8851b_txpwr_lmt;
		} else {
			return (void *) array_mp_8851b_txpwr_lmt_ru;
		}
	}
}

u32 _halrf_power_by_rate_table_size_8851b(struct rf_info *rf)
{
	u8 rfe_type = rf->phl_com->dev_cap.rfe_type;
	...
	if (rfe_type == 2) {
		return sizeof(array_mp_8851b_txpwr_byrate_type2);
	} else {
		return sizeof(array_mp_8851b_txpwr_byrate);
	}
}

void *_halrf_power_by_rate_table_addr_8851b(struct rf_info *rf)
{
	u8 rfe_type = rf->phl_com->dev_cap.rfe_type;
	...
	if (rfe_type == 2) {
		return (void *) array_mp_8851b_txpwr_byrate_type2;
	} else {
		return (void *) array_mp_8851b_txpwr_byrate;
	}
}

bool halrf_check_cond_8851b(struct rf_info *rf, u32 para_opt)
{
...
u32
halrf_get_8851b_nctl_reg_ver(void)
{
	return 0xa;
}

u32
halrf_get_8851b_radio_reg_ver(void)
{
	return RF_RELEASE_VERSION_8851B;
}

void halrf_config_8851b_store_radio_a_reg(struct rf_info *rf,
					u32 addr, u32 data)
{
...
void halrf_config_8851b_store_radio_b_reg(struct rf_info *rf,
					u32 addr, u32 data)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8851b_write_radio_a_reg_to_fw(struct rf_info *rf)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8851b_write_radio_b_reg_to_fw(struct rf_info *rf)
{
	struct halrf_radio_info *radio = &rf->radio_info;
...
void halrf_config_8851b_radio_to_fw(struct rf_info *rf)
{
	halrf_config_8851b_write_radio_a_reg_to_fw(rf);
}

void halrf_config_8851b_nctl_reg(struct rf_info *rf)
{
	u32	i = 0;
	u32	array_len = 0x0;
	u32 *array = NULL;
...
#if 0
//A-mode
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00010);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00000);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x0023c);
...
//G-mode
	...
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00001);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00022);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00003);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00022);
	halrf_wrf(rf, RF_PATH_A, 0x33, MASKRF, 0x00009);
	halrf_wrf(rf, RF_PATH_A, 0x3f, MASKRF, 0x00022);
	halrf_wrf(rf, RF_PATH_A, 0xec, MASKRF, 0x00000);
#endif
//5. iqkdpk clk&rst
	...
	array_len = sizeof(array_mp_8851b_nctl_reg) / sizeof(u32);
	array = (u32 *) &array_mp_8851b_nctl_reg;
	...
	while ((i + 1) < array_len) {
		v1 = array[i];
		v2 = array[i + 1];
		halrf_cfg_rf_nctl_8851b(rf, v1, MASKDWORD, v2);
		i += 2;
	}
#if 1
//00c_set_iqk_bb_default_reg
	...
	halrf_wreg(rf, 0x0730, 0x00003800, 0x7);
	//halrf_wreg(rf, 0x0704, 0x00001000, 0x1);
	halrf_wreg(rf, 0x2730, 0x00003800, 0x7);
	//halrf_wreg(rf, 0x2704, 0x00001000, 0x1);
//00d_set_AD_die_TxRFC
	halrf_wreg(rf, 0x0c7c, 0x00e00000, 0x1);
	halrf_wreg(rf, 0x58c0, 0x0001ffff, 0x00000);
	halrf_wreg(rf, 0x78c0, 0x0001ffff, 0x00000);
	halrf_wreg(rf, 0x58fc, 0x3f000000, 0x00);
	halrf_wreg(rf, 0x78fc, 0x3f000000, 0x00);
#endif
	halrf_write_fwofld_end(rf);

}

bool halrf_sel_headline_8851b(struct rf_info *rf, u32 *array, u32 array_len,
			      u8 *headline_size, u8 *headline_idx)
{
	...
	*headline_size = 0;
	...
	compare_target = ((rfe_drv & 0xff) << 16) | (DONT_CARE_8851B & 0xff);
...
void halrf_flag_2_default_8851b(bool *is_matched, bool *find_target)
{
	*is_matched = true;
	*find_target = false;
}
...
void
halrf_config_8851b_radio_a_reg(struct rf_info *rf, enum phl_phy_idx phy)
{
	struct rtw_hal_com_t *hal = rf->hal_com;
	struct halrf_radio_info *radio = &rf->radio_info;
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8851b_radioa) / sizeof(u32);
		array = (u32 *)array_mp_8851b_radioa;
	}

	RF_DBG(rf, DBG_RF_INIT, "RFCR_form_folder=%d, len=%d\n",
	       is_form_folder, array_len);

	if (!halrf_sel_headline_8851b(rf, array, array_len, &h_size, &h_idx)) {
	...
	halrf_flag_2_default_8851b(&is_matched, &find_target);
	while ((i + 1) < array_len) {
		v1 = array[i];
		v2 = array[i + 1];
		i += 2;
		...
		default:
			if (is_matched) {
				halrf_cfg_rf_radio_a_8851b(rf, v1, v2);
				halrf_config_8851b_store_radio_a_reg(rf, v1, v2);
			}
			break;
		}
	}
...
void
halrf_config_8851b_radio_b_reg(struct rf_info *rf, enum phl_phy_idx phy)
{
#if 0
#if 0
	struct rtw_hal_com_t *hal = rf->hal_com;
	...
	if (is_form_folder) {
		...
		array_len = sizeof(array_mp_8851b_radiob) / sizeof(u32);
		array = (u32 *)array_mp_8851b_radiob;
	}
	...
	while ((i + 1) < array_len) {
		...
		/*Check this para-setting meets driver's requirement or not*/
			if (is_skipped) {
				...
				//rpt = halbb_check_cond_8851b(bb, rfe_type, cv);
			...
			if (is_matched) {
				halrf_cfg_rf_radio_b_8851b(rf, v1, v2);
				halrf_config_8851b_store_radio_b_reg(rf, v1, v2);
				is_rfe_match = false;
				is_else_case = false;
	...
	//halrf_write_fwofld_end(rf);
	RF_DBG(rf, DBG_RF_INIT, "RFCR Init Success\n");
	halrf_config_8851b_write_radio_b_reg_to_fw(rf);
#endif
#endif
}

void
halrf_config_8851b_store_power_by_rate(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (!rtw_hal_txpwr_by_rate_store_from_external(rf->hal_com, phy_reg_info)) {
		array_len = _halrf_power_by_rate_table_size_8851b(rf) / sizeof(u32);
		array = (u32 *) _halrf_power_by_rate_table_addr_8851b(rf);
...
void
halrf_config_8851b_store_power_limit(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (!rtw_hal_txpwr_lmt_store_from_external(rf->hal_com, pwrlmt_info)) {
		array_len = _halrf_power_limit_table_size_8851b(rf, PW_LMT_TBL_NONE_RU, PW_LMT_TBL) / sizeof(struct halrf_tx_pw_lmt);
		array = (struct halrf_tx_pw_lmt *) _halrf_power_limit_table_addr_8851b(rf, PW_LMT_TBL_NONE_RU, PW_LMT_TBL);
	...
	/* cp 1TX MAIN to 2TX Aux */
	halrf_power_limit_ntx_cpy(rf, PW_LMT_PH_2T, PW_LMT_PH_1T);
...
void
halrf_config_8851b_store_power_limit_ru(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (!rtw_hal_txpwr_lmt_ru_store_from_external(rf->hal_com, pwrlmt_info)) {
		array_len = _halrf_power_limit_table_size_8851b(rf, PW_LMT_TBL_RU, PW_LMT_TBL) / sizeof(struct halrf_tx_pw_lmt_ru);
		array = (struct halrf_tx_pw_lmt_ru *) _halrf_power_limit_table_addr_8851b(rf, PW_LMT_TBL_RU, PW_LMT_TBL);
	...
	/* cp 1TX MAIN to 2TX Aux */
	halrf_power_limit_ru_ntx_cpy(rf, PW_LMT_PH_2T, PW_LMT_PH_1T);
...
void
halrf_config_8851b_store_pwr_track(struct rf_info *rf,
	enum phl_phy_idx phy)
{
	...
	if (is_form_folder) {
		...
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2ga_p,
			(void *)delta_swingidx_mp_2ga_p_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2ga_n,
			(void *)delta_swingidx_mp_2ga_n_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE);

		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_a_p,
			(void *)delta_swingidx_mp_2g_cck_a_p_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_2g_cck_a_n,
			(void *)delta_swingidx_mp_2g_cck_a_n_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE);

		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5ga_p,
			(void *)delta_swingidx_mp_5ga_p_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE * 3);
		hal_mem_cpy(hal, pwr_trk->delta_swing_table_idx_5ga_n,
			(void *)delta_swingidx_mp_5ga_n_txpwrtrkssi_8851b,
			DELTA_SWINGIDX_SIZE * 3);
	}
}

void
_halrf_config_rfe_xtal_track_table_8851b(struct rf_info *rf)
{
#if 0
	...
	hal_mem_cpy(hal, xtal_trk->delta_swing_xtal_table_idx_p,
		(void *)delta_swing_xtal_mp_p_txxtaltrack_8851b,
		DELTA_SWINGIDX_SIZE);
	hal_mem_cpy(hal, xtal_trk->delta_swing_xtal_table_idx_n,
		(void *)delta_swing_xtal_mp_n_txxtaltrack_8851b,
		DELTA_SWINGIDX_SIZE);
#endif
}

void
halrf_config_8851b_store_xtal_track(struct rf_info *rf,
	enum phl_phy_idx phy)
{
#if 0
	...
	if (is_form_folder) {
		...
		_halrf_config_rfe_xtal_track_table_8851b(rf);
	}
#else
	_halrf_config_rfe_xtal_track_table_8851b(rf);
#endif
