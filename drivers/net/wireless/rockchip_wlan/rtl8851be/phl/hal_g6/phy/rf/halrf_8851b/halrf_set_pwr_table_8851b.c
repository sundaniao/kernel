...
void _halrf_set_tx_shape_8851b(struct rf_info *rf, enum phl_phy_idx phy)
{
	...
	if (ch >= 1 && ch <= 14) {
		if (halrf_get_regulation_info(rf, BAND_ON_24G) >= PW_LMT_MAX_PER_BAND_REGU_NUM) {
			RF_DBG(rf, DBG_RF_POWER, "[TX shape] halrf_get_regulation_info(BAND_ON_24G)(%d) >= array index(%d) Return!!!\n",
				halrf_get_regulation_info(rf, BAND_ON_24G), PW_LMT_MAX_PER_BAND_REGU_NUM);
			return;
		} else
		...
		if (halrf_get_regulation_info(rf, BAND_ON_5G) >= PW_LMT_MAX_PER_BAND_REGU_NUM) {
			RF_DBG(rf, DBG_RF_POWER, "[TX shape] halrf_get_regulation_info(BAND_ON_5G)(%d) >= array index(%d) Return!!!\n",
				halrf_get_regulation_info(rf, BAND_ON_5G), PW_LMT_MAX_PER_BAND_REGU_NUM);
			return;
		} else
...
void _halrf_set_ext_power_diff_8851b(struct rf_info *rf, enum phl_phy_idx phy)
{
	struct rtw_tpu_info *tpu = &rf->hal_com->band[phy].rtw_tpu_i;
	struct halrf_pwr_info *pwr = &rf->pwr_info;
	...
	if (band == BAND_ON_24G) {
		...
		if (reg < PW_LMT_MAX_REGULATION_NUM) {
			if (pwr->toal_pwr_diff_2g[reg][RF_PATH_A] > pwr->toal_pwr_diff_2g[reg][RF_PATH_B])
				pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_2g[reg][RF_PATH_B] - pwr->toal_pwr_diff_2g[reg][RF_PATH_A];
			else
				pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_2g[reg][RF_PATH_A] - pwr->toal_pwr_diff_2g[reg][RF_PATH_B];
		}
		...
		if (channel >= 36 && channel <= 48) {
			if (reg < PW_LMT_MAX_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_5g[reg][RF_PATH_A][0] > pwr->toal_pwr_diff_5g[reg][RF_PATH_B][0])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_5g[reg][RF_PATH_B][0] - pwr->toal_pwr_diff_5g[reg][RF_PATH_A][0];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_5g[reg][RF_PATH_A][0] - pwr->toal_pwr_diff_5g[reg][RF_PATH_B][0];
			}
			...
			if (reg < PW_LMT_MAX_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_5g[reg][RF_PATH_A][1] > pwr->toal_pwr_diff_5g[reg][RF_PATH_B][1])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_5g[reg][RF_PATH_B][1] - pwr->toal_pwr_diff_5g[reg][RF_PATH_A][1];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_5g[reg][RF_PATH_A][1] - pwr->toal_pwr_diff_5g[reg][RF_PATH_B][1];
			}
			...
			if (reg < PW_LMT_MAX_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_5g[reg][RF_PATH_A][2] > pwr->toal_pwr_diff_5g[reg][RF_PATH_B][2])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_5g[reg][RF_PATH_B][2] - pwr->toal_pwr_diff_5g[reg][RF_PATH_A][2];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_5g[reg][RF_PATH_A][2] - pwr->toal_pwr_diff_5g[reg][RF_PATH_B][2];
			}
			...
			if (reg < PW_LMT_MAX_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_5g[reg][RF_PATH_A][3] > pwr->toal_pwr_diff_5g[reg][RF_PATH_B][3])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_5g[reg][RF_PATH_B][3] - pwr->toal_pwr_diff_5g[reg][RF_PATH_A][3];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_5g[reg][RF_PATH_A][3] - pwr->toal_pwr_diff_5g[reg][RF_PATH_B][3];
			}
		...
		if (channel >= 1 && channel <= 45) {
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][0] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][0])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][0] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][0];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][0] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][0];
			}
			...
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][1] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][1])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][1] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][1];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][1] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][1];
			}
			...
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][2] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][2])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][2] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][2];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][2] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][2];
			}
			...
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][3] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][3])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][3] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][3];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][3] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][3];
			}
			...
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][4] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][4])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][4] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][4];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][4] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][4];
			}
			...
			if (reg < PW_LMT_MAX_6G_REGULATION_NUM) {
				if (pwr->toal_pwr_diff_6g[reg][RF_PATH_A][5] > pwr->toal_pwr_diff_6g[reg][RF_PATH_B][5])
					pwr->ext_pwr_diff[RF_PATH_B] = pwr->toal_pwr_diff_6g[reg][RF_PATH_B][5] - pwr->toal_pwr_diff_6g[reg][RF_PATH_A][5];
				else
					pwr->ext_pwr_diff[RF_PATH_A] = pwr->toal_pwr_diff_6g[reg][RF_PATH_A][5] - pwr->toal_pwr_diff_6g[reg][RF_PATH_B][5];
			}
	...
	enum phl_pwr_table pwr_table)
{
	...
	_halrf_set_ext_power_diff_8851b(rf, phy);
		...
		char input[][16], u32 *_used, char *output, u32 *_out_len)
{
	...
	s32 s_cck_ref, s_ofdm_ref;
	s32 int_tmp[2], float_tmp[2];
//	s32 ant_gain_2g = 0, ant_gain_5g = 0, ant_gain_6g = 0;
	u32 power_constraint = pwr->power_constraint[0];
	s8 tmp[6] = {0};
	s32 tmp1[2] = {0};
	u32 i;
	...
	(tmp[0] < 0) ? (tmp[0] = -1 * tmp[0]) : (tmp[0] = 1 * tmp[0]);
	(tmp[1] < 0) ? (tmp[1] = -1 * tmp[1]) : (tmp[1] = 1 * tmp[1]);
	(tmp[2] < 0) ? (tmp[2] = -1 * tmp[2]) : (tmp[2] = 1 * tmp[2]);
	(tmp[3] < 0) ? (tmp[3] = -1 * tmp[3]) : (tmp[3] = 1 * tmp[3]);
	(tmp[4] < 0) ? (tmp[4] = -1 * tmp[4]) : (tmp[4] = 1 * tmp[4]);
	RF_DBG_CNSL(out_len, used, output + used, out_len - used,
		" %-30s = %s%d.%02d / %s%d.%02d / %s%d.%02d / %s%d.%02d / %s%d.%02d\n",
	...
	if (halrf_get_regulation_info(rf, BAND_ON_24G) < PW_LMT_MAX_REGULATION_NUM)
		ant_gain_2g = pwr->ant_gain_2g_oft[halrf_get_regulation_info(rf, BAND_ON_24G)][RF_PATH_A] * 100 / 4;
	if (channel >= 36 && channel <= 48)
		sb = 0;
	else if (channel >= 50 && channel <= 64)
		sb = 1;
	...
	if (halrf_get_regulation_info(rf, BAND_ON_5G) < PW_LMT_MAX_REGULATION_NUM)
		ant_gain_5g = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][sb] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d / %s%d.%d dB\n",
		...
		(ant_gain_6g < 0) ? (ant_gain_6g % 100) * -1 : (ant_gain_6g % 100));
#else
	tmp[0] = pwr->ant_gain_2g_oft[halrf_get_regulation_info(rf, BAND_ON_24G)][RF_PATH_A] * 100 / 4;
	tmp[1] = pwr->ant_gain_2g_oft[halrf_get_regulation_info(rf, BAND_ON_24G)][RF_PATH_B] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d dB\n",
		"Ant Gain Offset 2G A / B",
		(tmp[0] < 0) ? "-" : "",
		(tmp[0] < 0) ? (tmp[0] / 100) * -1 : (tmp[0] / 100),
		(tmp[0] < 0) ? (tmp[0] % 100) * -1 : (tmp[0] % 100),
		(tmp[1] < 0) ? "-" : "",
		(tmp[1] < 0) ? (tmp[1] / 100) * -1 : (tmp[1] / 100),
		(tmp[1] < 0) ? (tmp[1] % 100) * -1 : (tmp[1] % 100));

	tmp[0] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][0] * 100 / 4;
	tmp[1] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][1] * 100 / 4;
	tmp[2] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][2] * 100 / 4;
	tmp[3] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][3] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d dB\n",
		"Ant Gain Offset 5G A",
		(tmp[0] < 0) ? "-" : "",
		(tmp[0] < 0) ? (tmp[0] / 100) * -1 : (tmp[0] / 100),
		(tmp[0] < 0) ? (tmp[0] % 100) * -1 : (tmp[0] % 100),
		(tmp[1] < 0) ? "-" : "",
		...
		(tmp[1] < 0) ? (tmp[1] % 100) * -1 : (tmp[1] % 100),
		(tmp[2] < 0) ? "-" : "",
		(tmp[2] < 0) ? (tmp[2] / 100) * -1 : (tmp[2] / 100),
		(tmp[2] < 0) ? (tmp[2] % 100) * -1 : (tmp[2] % 100),
		(tmp[3] < 0) ? "-" : "",
		(tmp[3] < 0) ? (tmp[3] / 100) * -1 : (tmp[3] / 100),
		(tmp[3] < 0) ? (tmp[3] % 100) * -1 : (tmp[3] % 100));

	tmp[0] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_B][0] * 100 / 4;
	tmp[1] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_B][1] * 100 / 4;
	tmp[2] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_B][2] * 100 / 4;
	tmp[3] = pwr->ant_gain_5g_oft[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_B][3] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d dB\n",
		"Ant Gain Offset 5G B",
		(tmp[0] < 0) ? "-" : "",
		(tmp[0] < 0) ? (tmp[0] / 100) * -1 : (tmp[0] / 100),
		(tmp[0] < 0) ? (tmp[0] % 100) * -1 : (tmp[0] % 100),
		(tmp[1] < 0) ? "-" : "",
	...
	tmp[0] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][0] * 100 / 4;
	tmp[1] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][1] * 100 / 4;
	tmp[2] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][2] * 100 / 4;
	tmp[3] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][3] * 100 / 4;
	tmp[4] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][4] * 100 / 4;
	tmp[5] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][5] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d dB\n",
		"Ant Gain Offset 6G A",
		(tmp[0] < 0) ? "-" : "",
		(tmp[0] < 0) ? (tmp[0] / 100) * -1 : (tmp[0] / 100),
		(tmp[0] < 0) ? (tmp[0] % 100) * -1 : (tmp[0] % 100),
		(tmp[1] < 0) ? "-" : "",
		...
		(tmp[3] < 0) ? (tmp[3] % 100) * -1 : (tmp[3] % 100),
		(tmp[4] < 0) ? "-" : "",
		(tmp[4] < 0) ? (tmp[4] / 100) * -1 : (tmp[4] / 100),
		(tmp[4] < 0) ? (tmp[4] % 100) * -1 : (tmp[4] % 100),
		(tmp[5] < 0) ? "-" : "",
		(tmp[5] < 0) ? (tmp[5] / 100) * -1 : (tmp[5] / 100),
		(tmp[5] < 0) ? (tmp[5] % 100) * -1 : (tmp[5] % 100));

	tmp[0] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][0] * 100 / 4;
	tmp[1] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][1] * 100 / 4;
	tmp[2] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][2] * 100 / 4;
	tmp[3] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][3] * 100 / 4;
	tmp[4] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][4] * 100 / 4;
	tmp[5] = pwr->ant_gain_6g_oft[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][5] * 100 / 4;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d / %s%d.%d dB\n",
		"Ant Gain Offset 6G B",
		(tmp[0] < 0) ? "-" : "",
		(tmp[0] < 0) ? (tmp[0] / 100) * -1 : (tmp[0] / 100),
		(tmp[0] < 0) ? (tmp[0] % 100) * -1 : (tmp[0] % 100),
		(tmp[1] < 0) ? "-" : "",
	...
	if (band == BAND_ON_24G) {
		tmp[RF_PATH_A] = pwr->toal_pwr_diff_2g[halrf_get_regulation_info(rf, BAND_ON_24G)][RF_PATH_A];
		tmp[RF_PATH_B] = pwr->toal_pwr_diff_2g[halrf_get_regulation_info(rf, BAND_ON_24G)][RF_PATH_B];
	} else if (band == BAND_ON_5G) {
		if (channel >= 36 && channel <= 48)
			sb = 0;
		else if (channel >= 50 && channel <= 64)
			...
			sb = 3;
		tmp[RF_PATH_A] = pwr->toal_pwr_diff_5g[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_A][sb];
		tmp[RF_PATH_B] = pwr->toal_pwr_diff_5g[halrf_get_regulation_info(rf, BAND_ON_5G)][RF_PATH_B][sb];
	} else {
		if (channel >= 1 && channel <= 45)
			sb = 0;
		else if (channel >= 49 && channel <= 93)
			...
			sb = 5;
		tmp[RF_PATH_A] = pwr->toal_pwr_diff_6g[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_A][sb];
		tmp[RF_PATH_B] = pwr->toal_pwr_diff_6g[halrf_get_regulation_info(rf, BAND_ON_6G)][RF_PATH_B][sb];
	}

	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %d.%02d / %d.%02d\n",
		"TX Final Pwr dif Ext+Ant A / B",
		tmp[RF_PATH_A] / 4,
		(tmp[RF_PATH_A] < 0) ? (-1 * ((tmp[RF_PATH_A] * 100) / 4) % 100) : (((tmp[RF_PATH_A] * 100) / 4) % 100),
		tmp[RF_PATH_B] / 4,
		(tmp[RF_PATH_B] < 0) ? (-1 * ((tmp[RF_PATH_B] * 100) / 4) % 100) : (((tmp[RF_PATH_B] * 100) / 4) % 100)
		);
#endif

	tmp1[0] = halrf_rreg(rf, 0x1c78, 0x1ff);
	(tmp1[0] & BIT(8)) ? (tmp1[0] = tmp1[0] | 0xfffffe00) : 0;
	tmp1[1] = halrf_rreg(rf, 0x3c78, 0x1ff);
	(tmp1[1] & BIT(8)) ? (tmp1[1] = tmp1[1] | 0xfffffe00) : 0;
	RF_DBG_CNSL(out_len, used, output + used, out_len - used, " %-30s = %d.%d / %d.%d\n",
		 "T-MAC xdbm A / B",
		 tmp1[0] / 4, (tmp1[0] < 0) ? (-1 * ((tmp1[0] * 100) / 4) % 100) : ((tmp1[0] * 100) / 4) % 100,
		 tmp1[1] / 4, (tmp1[1] < 0) ? (-1 * ((tmp1[1] * 100) / 4) % 100) : ((tmp1[1] * 100) / 4) % 100);
