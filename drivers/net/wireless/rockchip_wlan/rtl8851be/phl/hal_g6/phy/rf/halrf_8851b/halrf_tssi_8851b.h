 ...
 *
 *****************************************************************************/
#ifndef _HALRF_TSSI_8851B_H_
#define _HALRF_TSSI_8851B_H_
#ifdef RF_8851B_SUPPORT

#define TSSI_VER_8851B 0x8

#define TSSI_PATH_MAX_8851B 1
...
void halrf_set_tssi_de_offset_zero_8851b(struct rf_info *rf,
							enum phl_phy_idx phy);
void halrf_do_tssi_8851b(struct rf_info *rf, enum phl_phy_idx phy, bool hwtx_en);
void halrf_do_tssi_scan_8851b(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_tssi_enable_8851b(struct rf_info *rf, enum phl_phy_idx phy);
void halrf_tssi_disable_8851b(struct rf_info *rf, enum phl_phy_idx phy);
s32 halrf_get_online_tssi_de_8851b(struct rf_info *rf, enum phl_phy_idx phy_idx,
				u8 path, s32 dbm, s32 puot);
void halrf_tssi_cck_8851b(struct rf_info *rf, enum phl_phy_idx phy,
				bool is_cck);
void halrf_set_tssi_avg_mp_8851b(struct rf_info *rf,
...
#endif
#endif	/*_HALRF_SET_PWR_TABLE_8851B_H_*/