 ...
 *
 *****************************************************************************/
#ifndef __HALBB_8851B_API_H__
#define __HALBB_8851B_API_H__
...
#define BB_PATH_MAX_8851B 1
#define GAIN_HIDE_EFUSE_A_2G_8851B 0x5BB
#define GAIN_HIDE_EFUSE_A_5GL_8851B 0x5BA
#define GAIN_HIDE_EFUSE_A_5GM_8851B 0x5B9
#define GAIN_HIDE_EFUSE_A_5GH_8851B 0x5B8

/*@--------------------------[Enum]------------------------------------------*/
/*@--------------------------[Structure]-------------------------------------*/
struct bb_h2c_lps_info_8851b {
	u8 central_ch;
	u8 pri_ch;
	u8 bw;
	u8 band_type;
...
bool halbb_write_rf_reg_8851b(struct bb_info *bb, enum rf_path path, u32 reg_addr,
...
void halbb_tssi_bb_reset_8851b(struct bb_info *bb);
...
bool halbb_ctrl_ch2_80p80_8851b(struct bb_info *bb, u8 central_ch);
...
void halbb_set_igi_8851b(struct bb_info *bb, u8 lna_idx, bool tia_idx,
			u8 rxbb_idx);
void halbb_set_tx_pow_ref_8851b(struct bb_info *bb, s16 pw_dbm_ofdm,
...
void halbb_agc_step_en_8851b(struct bb_info *bb, bool pre_pd_agc_en,
			     ...
			     bool nlgc_agc_en);
void halbb_set_gain_error_8851b(struct bb_info *bb, u8 central_ch, enum band_type band_type);
...
void halbb_set_rxsc_rpl_comp_8851b(struct bb_info *bb, u8 central_ch, enum band_type band_type);
...
#endif
#endif
#endif /*  __INC_PHYDM_API_H_8851B__ */
