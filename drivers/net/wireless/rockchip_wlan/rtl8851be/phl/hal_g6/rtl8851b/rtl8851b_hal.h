...
/* Regulation */
u8 hal_query_group_cntry_num_8851b(
	struct rtw_regu_policy *policy, u8 group_id);

u8 hal_get_cntry_idx_8851b(char *cntry);

u8 hal_get_cntry_tbl_size_8851b(void);

u8 hal_get_chnlplan_ver_8851b(void);

u8 hal_get_country_ver_8851b(void);

u8 hal_get_domain_regulation_8851b(
	u8 domain, u8 band);

u8 hal_get_domain_idx_8851b(u8 domain, bool is_6g);

u8 hal_get_cat6g_by_country_8851b(char *country);

void hal_get_6g_regulatory_info_8851b(u8 domain,
	u8 *dm_code, u8 *regulation, u8 *ch_idx);

void hal_qry_cntry_chnlplan_8851b(
	struct rtw_regulation_country_chplan *chplan, char *country);

void hal_get_chplan_update_info_8851b(
	u8 group, u8 did, void *info, enum band_type band);

void hal_fill_group_cntry_list_8851b(
	struct rtw_regu_policy *policy,
	char* list, u32 group_size, u8 group_id);

void hal_get_chdef_6g_8851b(
	u8 ch_idx, struct chdef_6ghz *chdef);

void hal_get_regu_func_cert_info_8851b(char *country,
