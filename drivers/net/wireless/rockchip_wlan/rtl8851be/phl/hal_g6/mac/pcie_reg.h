...
#define MANUAL_LVL_SH		        5
#define MANUAL_LVL_MSK		        0xF
...
#define OFFSET_CAL_SH		        4
#define OFFSET_CAL_MSK		        0xF
...
#define PCIE_BIT_STS_ASPM_MSK		(PCIE_BIT_STS_CLK_PM | PCIE_BIT_STS_L1 | PCIE_BIT_STS_L0S)
...
/* 8852C PCIE SER Dump */
#define PCIE_DUMP_L1_BACKDOOR_SH	    11
#define PCIE_DUMP_L1_BACKDOOR_MSK	    0x1
#define PCIE_DUMP_L1SS_BACKDOOR_SH	    5
#define PCIE_DUMP_L1SS_BACKDOOR_MSK	    0x1
#define PCIE_DUMP_CLKREQ_DLY_SH	        16
#define PCIE_DUMP_CLKREQ_DLY_MSK	    0xF
