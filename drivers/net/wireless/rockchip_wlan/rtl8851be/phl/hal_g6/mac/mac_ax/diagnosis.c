...
#if (MAC_AX_8852A_SUPPORT || MAC_AX_8852B_SUPPORT || MAC_AX_8851B_SUPPORT || MAC_AX_8852BT_SUPPORT || MAC_AX_8852C_SUPPORT || MAC_AX_8852D_SUPPORT || MAC_BE_8922A_SUPPORT || MAC_BE_8922D_SUPPORT)
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8852B) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8851B) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8852BT) ||
		...
		*check_number += 1;
		...
		if ((reg1 & 0x1FE) != 0x142)
			MAC_DBG_MSG(out_len, *used, output + *used, out_len - *used, "func: %s, Reg: 0x80 => %x, ASPM L1/CPM not enable\n", __func__, reg1);
...
#endif // AP/NIC Compile flag
#ifdef PHL_FEATURE_NIC
#if (MAC_AX_8852A_SUPPORT || MAC_AX_8852B_SUPPORT || MAC_AX_8851B_SUPPORT || MAC_AX_8852BT_SUPPORT || MAC_AX_8852D_SUPPORT || MAC_BE_8922A_SUPPORT || MAC_BE_8922D_SUPPORT)
	if (is_chip_id(adapter, MAC_AX_CHIP_ID_8852A) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8852B) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8851B) ||
	    is_chip_id(adapter, MAC_AX_CHIP_ID_8852BT) ||
