			    ...
			    enum rtw_mac_gfunc func, s8 gpio_cfg)
{
	...
	if (gpio_cfg < MAC_AX_GPIO_MIN || gpio_cfg >= MAC_AX_GPIO_MAX_8851B) {
...
u32 mac_cfg_wps_8851b(struct mac_ax_adapter *adapter,
		      struct mac_ax_cfg_wps *wps)
{
	if (wps->gpio >= MAC_AX_GPIO_MAX_8851B) {
