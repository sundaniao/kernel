...
static struct mac_ax_intf_ops mac8851b_usb_ops = {
	...
	get_u3_perf_mode_8851b,/*get_u3_perf_mode*/
...
static struct mac_ax_intf_ops mac8851b_pcie_ops = {
	...
	poll_txdma_idle_pcie, /*poll_txdma_idle*/
	clr_hci_trx_pcie, /*clr_hci_trx*/
	lv2rst_stop_dma_pcie_8851b, /*lv2rst_stop_dma*/
};
#endif
...
static struct mac_ax_ops mac8851b_ops = {
	...
	mac_chk_mac_pwr_state, /*chk_ic_pwr_state*/
#endif
...
static struct mac_ax_hw_info mac8851b_hw_info = {
	...
	0x130F, /* txdma_ch_map */
	0x3, /* rxdma_ch_map */
	SHARE_MEM_SIZE_8851B, /* fifo_size */
	WL_EFUSE_FULL_SIZE_8851B, /* wl_efuse_size */
	WL_EFUSE_LOG_SIZE_8851B, /* efuse_size */
	WL_EFUSE_LOG_MAP_SIZE_8851B, /* log_efuse_size */
	BT_EFUSE_FULL_SIZE_8851B, /* bt_efuse_size */
	BT_EFUSE_LOG_MAP_SIZE_8851B, /* bt_log_efuse_size */
	WL_HIDDEN_EFUSE_RF_SIZE_8851B, /* hidden_efuse_rf_size */
	WL_HIDDEN_EFUSE_MAC_SIZE_8851B, /*hidden_efuse_mac_size*/
	WL_SEC_CTRL_EFUSE_SIZE_8851B, /* sec_ctrl_efuse_size */
	WL_SEC_DATA_EFUSE_SIZE_8851B, /* sec_data_efuse_size */
	DAV_FULL_EFUSE_SIZE_8851B, /* dav_full_efuse_size */
	DAV_EFUSE_LOG_SIZE_8851B, /* dav_efuse_size  */
	DAV_HIDDEN_EFUSE_SIZE_8851B, /* dav_hidden_efuse_size  */
	DAV_EFUSE_LOG_MAP_SIZE_8851B, /* dav_log_efuse_size  */
	CFG_DCTL_INFO_SIZE_8851B, /* dctl_info_size */
	0, /* sw_amsdu_max_size */
	...
	A_DIE_RL1_8851B, /* aid */
	MACID_NUM_8851B, /* macid_num */
	0, /* done */
	WL_EFUSE_MAP_VER_SIZE_8851B, /* efuse_version_size */
	D_DIE_CHIP_ID_8851B, /* chip_id */
	0xFF, /* cv */
	0, /* acv */
	0xFF, /* fv */
	TX_DMA_CH_NUM_8851B, /* tx_ch_num */
	TX_DMA_DATA_CH_NUM_8851B, /* tx_data_ch_num */
	WD_BODY_LEN, /* wd_body_len */
	WD_INFO_LEN, /* wd_info_len */
	PWR_SEQ_VER_8851B, /* pwr_seq_ver */
	HW_BAND_NUM_8851B, /* hw_band_num */
	PORT_NUM_8851B, /* port_num */
	MBSSID_NUM_8851B, /* mbssid_num */
	BSSIDCAM_NUM_8851B, /* bssid_num */
	WP_SEC_RSVD_SIZE_8851B, /* ple_rsvd_space */
	WP_PLD_DESC_SIZE_8851B, /* payload_desc_size */
	0, /* wd_checksum_en */
	0, /* core_swr_volt */
	MAX_AGG_TXTIME_HW_8851B, /*max_agg_txtime_reg*/
	0, /* bcn_pkt_drop */
};
...
static struct mac_ax_adapter mac_8851b_adapter =  {
	...
	{{0}}, /* ser_info */
	{0}, /* efuse_param */
	{pwr_on_seq_8851b, pwr_off_seq_8851b,
